# Generated by Django 3.2.8 on 2022-06-29 07:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('verseid', models.TextField(blank=True, null=True)),
                ('book', models.TextField(blank=True, null=True)),
                ('book_No', models.TextField(blank=True, null=True)),
                ('chapter', models.TextField(blank=True, null=True)),
                ('verses', models.TextField(blank=True, null=True)),
